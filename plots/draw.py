...
if __name__ == '__main__':
    ...
    if not os.path.isdir(os.path.join(os.path.dirname(os.path.abspath(__file__)), "experiments", experiment_name, "pngs")):
        os.makedirs(os.path.join(os.path.dirname(os.path.abspath(__file__)), "experiments", experiment_name, "pngs"))
    ...
    print(new_df)
    draw_percentiles_line_chart(percentiles_frame, "90%", png_prefix)
