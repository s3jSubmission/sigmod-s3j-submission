...
if __name__ == '__main__':
    ...
    if not os.path.isdir(os.path.join(os.path.dirname(os.path.abspath(__file__)), "experiments", experiment_name, "stats_files")):
        os.makedirs(os.path.join(os.path.dirname(os.path.abspath(__file__)), "experiments", experiment_name, "stats_files"))
    output_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), "experiments", experiment_name,  "stats_files")
