...
def start_join_job():
    ...
    machines_id = []
    step = (int(128 / parallelism)) + 1
    mid = 0
    while mid < step*parallelism:
        machines_id.append(mid)
        mid += step
...
def setup():
    ...
    for jar_path in [JOB_JAR_PATH, MIGRATION_JAR_PATH, GENERATOR_JAR_PATH, STATS_JAR_PATH]:
...
def reset_environment():
    global start_time, save_point_path, job_ids, job_arguments, join_job_id, migration_job_id, stats_job_id
